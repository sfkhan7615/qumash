        ...
        <div className="product-single product-single-1">
          <div className="row">
                ...
                <div className="zoompro-wrap product-zoom-right pl-20">
                  <div className="zoompro-span">
                    <img className="blur-up lazyload zoompro"
                      data-zoom-image="/images/product-detail-page/cape-dress-1.jpg"
                      alt="" src="/images/product-detail-page/cape-dress-1.jpg" />
                  </div>
                  ...
                  <div className="product-buttons">
                    <a href="https://www.youtube.com/watch?v=93A2jOW5Mog"
                      className="btn popup-video" title="View Video"><i
                        className="icon anm anm-play-r" aria-hidden="true"></i></a>
                    <a href="#" className="btn prlightbox" title="Zoom"><i
                      className="icon anm anm-expand-l-arrows" aria-hidden="true"></i></a>
                  </div>
                </div>
                <div className="product-thumb product-thumb-1">
                  <div id="gallery" className="product-dec-slider-1 product-tab-left">
                    <a data-image="/images/product-detail-page/cape-dress-1.jpg"
                      data-zoom-image="/images/product-detail-page/cape-dress-1.jpg"
                      className="slick-slide slick-cloned" data-slick-index="-4"
                      aria-hidden="true" tabIndex={-1}>
                      <img className="blur-up lazyload"
                        src="/images/product-detail-page/cape-dress-1.jpg" alt="" />
                    </a>
                    <a data-image="/images/product-detail-page/cape-dress-2.jpg"
                      data-zoom-image="/images/product-detail-page/cape-dress-2.jpg"
                      className="slick-slide slick-cloned" data-slick-index="-3"
                      aria-hidden="true" tabIndex={-1}>
                      <img className="blur-up lazyload"
                        src="/images/product-detail-page/cape-dress-2.jpg" alt="" />
                    </a>
                    <a data-image="/images/product-detail-page/cape-dress-3.jpg"
                      data-zoom-image="/images/product-detail-page/cape-dress-3.jpg"
                      className="slick-slide slick-cloned" data-slick-index="-2"
                      aria-hidden="true" tabIndex={-1}>
                      <img className="blur-up lazyload"
                        src="/images/product-detail-page/cape-dress-3.jpg" alt="" />
                    </a>
                    <a data-image="/images/product-detail-page/cape-dress-4.jpg"
                      data-zoom-image="/images/product-detail-page/cape-dress-4.jpg"
                      className="slick-slide slick-cloned" data-slick-index={-1}
                      aria-hidden="true" tabIndex={-1}>
                      <img className="blur-up lazyload"
                        src="/images/product-detail-page/cape-dress-4.jpg" alt="" />
                    </a>
                    <a data-image="/images/product-detail-page/cape-dress-5.jpg"
                      data-zoom-image="/images/product-detail-page/cape-dress-5.jpg"
                      className="slick-slide slick-cloned" data-slick-index="0" aria-hidden="true"
                      tabIndex={-1}>
                      <img className="blur-up lazyload"
                        src="/images/product-detail-page/cape-dress-5.jpg" alt="" />
                    </a>
                    <a data-image="/images/product-detail-page/cape-dress-6.jpg"
                      data-zoom-image="/images/product-detail-page/cape-dress-6.jpg"
                      className="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true"
                      tabIndex={-1}>
                      <img className="blur-up lazyload"
                        src="/images/product-detail-page/cape-dress-6.jpg" alt="" />
                    </a>
                    <a data-image="/images/product-detail-page/cape-dress-7.jpg"
                      data-zoom-image="/images/product-detail-page/cape-dress-7.jpg"
                      className="slick-slide slick-cloned" data-slick-index="2" aria-hidden="true"
                      tabIndex={-1}>
                      <img className="blur-up lazyload"
                        src="/images/product-detail-page/cape-dress-7.jpg" alt="" />
                    </a>
                    <a data-image="/images/product-detail-page/cape-dress-8.jpg"
                      data-zoom-image="/images/product-detail-page/cape-dress-8.jpg"
                      className="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true"
                      tabIndex={-1}>
                      <img className="blur-up lazyload"
                        src="/images/product-detail-page/cape-dress-8.jpg" alt="" />
                    </a>
                  </div>
                </div>
                <div className="lightboximages">
                  <a href="/images/product-detail-page/camelia-reversible-big1.jpg"
                    data-size="1462x2048"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big2.jpg"
                    data-size="1462x2048"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big3.jpg"
                    data-size="1462x2048"></a>
                  <a href="/images/product-detail-page/camelia-reversible7-big.jpg"
                    data-size="1462x2048"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big4.jpg"
                    data-size="1462x2048"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big5.jpg"
                    data-size="1462x2048"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big6.jpg"
                    data-size="731x1024"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big7.jpg"
                    data-size="731x1024"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big8.jpg"
                    data-size="731x1024"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big9.jpg"
                    data-size="731x1024"></a>
                  <a href="/images/product-detail-page/camelia-reversible-big10.jpg"
                    data-size="731x1024"></a>
                </div>
              ...
              <div className="prFeatures">
                <div className="row">
                  <div className="col-12 col-sm-12 col-md-12 col-lg-6 feature">
                    <img src="/images/credit-card.png" alt="Safe Payment"
                      title="Safe Payment" />
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="product-single__meta">
                <h1 className="product-single__title">Product Layout Style2</h1>
                ...
                <p className="product-single__price product-single__price-product-template">
                  ...
                  <span
                    ...
                    <span id="ProductPrice-product-template"><span
                      className="money">$788.00</span></span>
                  </span>
                ...
                <form method="post" action="http://annimexweb.com/cart/add"
                  ...
                  <div className="swatch clearfix swatch-0 option1" data-option-index="0">
                    <div className="product-form__item">
                      ...
                      <div data-value="Black" className="swatch-element color black available">
                        <input className="swatchInput" id="swatch-0-black" type="radio"
                          name="option-0" value="Black" />
                        <label
                          className="swatchLbl color small" htmlFor="swatch-0-black"
                          style={{ backgroundColor: "black" }} title="Black"></label>
                      </div>
                      <div data-value="Maroon" className="swatch-element color maroon available">
                        <input className="swatchInput" id="swatch-0-maroon" type="radio"
                          name="option-0" value="Maroon" />
                        <label
                          className="swatchLbl color small" htmlFor="swatch-0-maroon"
                          style={{ backgroundColor: "maroon" }} title="Maroon"></label>
                      </div>
                      <div data-value="Blue" className="swatch-element color blue available">
                        <input className="swatchInput" id="swatch-0-blue" type="radio"
                          name="option-0" value="Blue" />
                        <label
                          className="swatchLbl color small" htmlFor="swatch-0-blue"
                          style={{ backgroundColor: "blue" }} title="Blue"></label>
                      </div>
                      <div data-value="Dark Green"
                        className="swatch-element color dark-green available">
                        <input className="swatchInput" id="swatch-0-dark-green" type="radio"
                          name="option-0" value="Dark Green" />
                        <label
                          className="swatchLbl color small" htmlFor="swatch-0-dark-green"
                          style={{ backgroundColor: "darkgreen" }} title="Dark Green"></label>
                      </div>
                    </div>
                  </div>
                  <div className="swatch clearfix swatch-1 option2" data-option-index="1">
                    <div className="product-form__item">
                      ...
                      <div data-value="X-Small" className="swatch-element x-small available">
                        <input className="swatchInput" id="swatch-1-x-small" type="radio"
                          name="option-1" value="X-Small" />
                        <label
                          className="swatchLbl small rounded" htmlFor="swatch-1-x-small"
                          title="X-Small">X-Small</label>
                      </div>
                    </div>
                  </div>
                  <p className="infolinks"><a href="#sizechart" className="sizelink btn"> Size Guide</a>
                    <a href="#productInquiry" className="emaillink btn"> Ask About this Product</a>
                  </p>
                      ...
                      <div className="wrapQtyBtn">
                        <div className="qtyField">
                          ...
                          <input type="text" id="Quantity" name="quantity" value="1"
                            className="product-form__input qty" onChange={(e) => console.log(e.target.value)} />
              ...
              <div className="tabs-listing">
                <div className="tab-container">
                      ...
                      <div className="spr-container">
                        <div className="spr-header clearfix">
                          <div className="spr-summary">
                            <span className="product-review"><a className="reviewLink"><i
                              className="font-13 fa fa-star"></i><i
                                className="font-13 fa fa-star"></i><i
                                  className="font-13 fa fa-star"></i><i
                                    className="font-13 fa fa-star-o"></i><i
                                      className="font-13 fa fa-star-o"></i> </a><span
                                        className="spr-summary-actions-togglereviews">Based on 6
                                reviews456</span></span>
                            <span className="spr-summary-actions">
                              <a href="#"
                                className="spr-summary-actions-newreview btn">Write a
                                review</a>
                            </span>
                          </div>
                        </div>
                              ...
                              <fieldset className="spr-form-contact">
                                <div className="spr-form-contact-name">
                                  <label className="spr-form-label"
                                    htmlFor="review_author_10508262282">Name</label>
                                  <input
                                ...
                                <div className="spr-form-contact-email">
                                  <label className="spr-form-label"
                                    htmlFor="review_email_10508262282">Email</label>
                                  <input
                              ...
                              <fieldset className="spr-form-review">
                                <div className="spr-form-review-rating">
                                  ...
                                  <div className="spr-form-input spr-starrating">
                                    <div className="product-review"><a
                                      className="reviewLink" href="#"><i
                                        className="fa fa-star-o"></i><i
                                          className="font-13 fa fa-star-o"></i><i
                                            className="font-13 fa fa-star-o"></i><i
                                              className="font-13 fa fa-star-o"></i><i
                                                className="font-13 fa fa-star-o"></i></a>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="spr-form-review-title">
                                  <label className="spr-form-label"
                                    htmlFor="review_title_10508262282">Review
                                    Title</label>
                                  <input
                                    className="spr-form-input spr-form-input-text "
                                ...
                                <div className="spr-form-review-body">
                                  <label className="spr-form-label"
                                    htmlFor="review_body_10508262282">Body of Review
                                    <span
                                      className="spr-form-review-body-charactersremaining">(1500)</span></label>
                          ...
                          <div className="spr-reviews">
                            <div className="spr-review">
                              <div className="spr-review-header">
                                <span
                                  className="product-review spr-starratings spr-review-header-starratings"><span
                                    className="reviewLink"><i
                                      className="fa fa-star"></i><i
                                        className="font-13 fa fa-star"></i><i
                                          className="font-13 fa fa-star"></i><i
                                            className="font-13 fa fa-star"></i><i
                                              className="font-13 fa fa-star"></i></span></span>
                                <h3 className="spr-review-header-title">Lorem ipsum
                                  dolor sit amet</h3>
                                <span
                                  className="spr-review-header-byline"><strong>dsacc</strong>
                                  on <strong>Apr 09, 2019</strong></span>
                              </div>
                              <div className="spr-review-content">
                                <p className="spr-review-content-body">Lorem ipsum dolor
                                      ...
                                      className="fa fa-star"></i><i
                                        className="font-13 fa fa-star"></i><i
                                          className="font-13 fa fa-star"></i><i
                                            className="font-13 fa fa-star"></i><i
                                              className="font-13 fa fa-star"></i></span></span>
                                <h3 className="spr-review-header-title">Lorem Ipsum is
                                  simply dummy text of the printing</h3>
                                <span
                                  className="spr-review-header-byline"><strong>larrydude</strong>
                                  on <strong>Dec 30, 2018</strong></span>
                              </div>

                              <div className="spr-review-content">
                                <p className="spr-review-content-body"><br /><br />Lorem
                                      ...
                                      className="fa fa-star"></i><i
                                        className="font-13 fa fa-star"></i><i
                                          className="font-13 fa fa-star"></i><i
                                            className="font-13 fa fa-star"></i><i
                                              className="font-13 fa fa-star"></i></span></span>
                                <h3 className="spr-review-header-title">Neque porro
                                  quisquam est qui dolorem ipsum quia dolor sit
                                  amet, consectetur, adipisci velit...</h3>
                                <span
                                  className="spr-review-header-byline"><strong>quoctri1905</strong>
                                  on <strong>Dec 30, 2018</strong></span>
                              </div>

                              <div className="spr-review-content">
                                <p className="spr-review-content-body">Lorem Ipsum is
                                  simply dummy text of the printing and
                                  typesetting industry. Lorem Ipsum has been the
                                  industry's standard dummy text ever since the
                                  1500s, when an unknown printer took a galley of
                  ...
                  <h3 className="acor-ttl" rel="tab3">Size Chart</h3>
                  ...
                  <h3 className="acor-ttl" rel="tab4">Shipping &amp; Returns</h3>
          ...
          <div className="related-product grid-products">
            <header className="section-header">
              ...
              <p className="sub-heading">You can stop autoplay, increase/decrease aniamtion speed and
            ...
            <div className="productPageSlider">
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <form className="variants add" action="#" onClick={() => window.location.href = 'cart.html'}
                    method="post">
                    <button className="btn btn-addto-cart" type="button" tabIndex={0}>Select
                      Options</button>
                  </form>
                ...
                <div className="product-details text-center">
                  ...
                  <ul className="swatches">
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant1.jpg" alt="image" /></li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant2.jpg" alt="image" /></li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant3.jpg" alt="image" /></li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant4.jpg" alt="image" /></li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant5.jpg" alt="image" /></li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant6.jpg" alt="image" /></li>
                  </ul>
              ...
              <div className="col-12 item">
                ...
                <div className="product-details text-center">
                  ...
                  <ul className="swatches">
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant2-1.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant2-2.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant2-3.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant2-4.jpg" alt="image" />
                    </li>
                  </ul>
              ...
              <div className="col-12 item">
                ...
                <div className="product-details text-center">
                  ...
                  <ul className="swatches">
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant3-1.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant3-2.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant3-3.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant3-4.jpg" alt="image" />
                    </li>
                  </ul>
              ...
              <div className="col-12 item">
                ...
                <div className="product-details text-center">
                  ...
                  <ul className="swatches">
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant4-1.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant4-2.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant4-3.jpg" alt="image" />
                    </li>
                    <li className="swatch medium rounded"><img
                      src="/images/product-images/variant4-4.jpg" alt="image" />
                    </li>
                  </ul>
              ...
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <a href="#">
                    ...
                    <img className="primary blur-up lazyload"
                      data-src="/images/product-images/product-image6.jpg"
                      src="/images/product-images/product-image6.jpg" alt="image"
                      title="product" />


                    <img className="hover blur-up lazyload"
                      data-src="/images/product-images/product-image6-1.jpg"
                      src="/images/product-images/product-image6-1.jpg" alt="image"
                      title="product" />
              ...
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <a href="#">
                    ...
                    <img className="primary blur-up lazyload"
                      data-src="/images/product-images/product-image7.jpg"
                      src="/images/product-images/product-image7.jpg" alt="image"
                      title="product" />


                    <img className="hover blur-up lazyload"
                      data-src="/images/product-images/product-image7-1.jpg"
                      src="/images/product-images/product-image7-1.jpg" alt="image"
                      title="product" />
          ...
          <div className="related-product grid-products">
            <header className="section-header">
              <h2 className="section-header__title text-center h2"><span>Recently Viewed Product</span>
              </h2>
              ...
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <a href="#">
                    ...
                    <img className="primary blur-up lazyload"
                      data-src="/images/product-images/product-image8.jpg"
                      src="/images/product-images/product-image8.jpg" alt="image"
                      title="product" />


                    <img className="hover blur-up lazyload"
                      data-src="/images/product-images/product-image8-1.jpg"
                      src="/images/product-images/product-image8-1.jpg" alt="image"
                      title="product" />
              ...
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <a href="#">
                    ...
                    <img className="primary blur-up lazyload"
                      data-src="/images/product-images/product-image9.jpg"
                      src="/images/product-images/product-image9.jpg" alt="image"
                      title="product" />


                    <img className="hover blur-up lazyload"
                      data-src="/images/product-images/product-image9-1.jpg"
                      src="/images/product-images/product-image9-1.jpg" alt="image"
                      title="product" />
              ...
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <a href="#">
                    ...
                    <img className="primary blur-up lazyload"
                      data-src="/images/product-images/product-image10.jpg"
                      src="/images/product-images/product-image10.jpg" alt="image"
                      title="product" />


                    <img className="hover blur-up lazyload"
                      data-src="/images/product-images/product-image10-1.jpg"
                      src="/images/product-images/product-image10-1.jpg" alt="image"
                      title="product" />
              ...
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <a href="#">
                    ...
                    <img className="primary blur-up lazyload"
                      data-src="/images/product-images/product-image13.jpg"
                      src="/images/product-images/product-image13.jpg" alt="image"
                      title="product" />


                    <img className="hover blur-up lazyload"
                      data-src="/images/product-images/product-image13-1.jpg"
                      src="/images/product-images/product-image13-1.jpg" alt="image"
                      title="product" />
              ...
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <a href="#">
                    ...
                    <img className="primary blur-up lazyload"
                      data-src="/images/product-images/product-image14.jpg"
                      src="/images/product-images/product-image14.jpg" alt="image"
                      title="product" />


                    <img className="hover blur-up lazyload"
                      data-src="/images/product-images/product-image14-1.jpg"
                      src="/images/product-images/product-image14-1.jpg" alt="image"
                      title="product" />
              ...
              <div className="col-12 item">
                ...
                <div className="product-image">
                  ...
                  <a href="#">
                    ...
                    <img className="primary blur-up lazyload"
                      data-src="/images/product-images/product-image15.jpg"
                      src="/images/product-images/product-image15.jpg" alt="image"
                      title="product" />


                    <img className="hover blur-up lazyload"
                      data-src="/images/product-images/product-image15-1.jpg"
                      src="/images/product-images/product-image15-1.jpg" alt="image"
                      title="product" />
        ...
        <div className="pswp__scroll-wrap">
            ...
            <div className="pswp__ui pswp__ui--hidden">
                <div className="pswp__top-bar">
                    <div className="pswp__counter"></div><button className="pswp__button pswp__button--close"
                        title="Close (Esc)"></button><button className="pswp__button pswp__button--share"
                        title="Share"></button><button className="pswp__button pswp__button--fs"
                        title="Toggle fullscreen"></button><button className="pswp__button pswp__button--zoom"
                ...
                </div><button className="pswp__button pswp__button--arrow--left"
                    title="Previous (arrow left)"></button><button className="pswp__button pswp__button--arrow--right"
