                        ...
                        <div className="swatch clearfix swatch-0 option1" data-option-index="0">
                          <div className="product-form__item">
                            ...
                            <div data-value="Red"
                              ...
                              <input className="swatchInput" id="swatch-0-red" type="radio"
                            ...
                            <div data-value="Green"
                              ...
                              <input className="swatchInput" id="swatch-0-green" type="radio"
                            ...
                            <div data-value="Gray"
                              ...
                              <input className="swatchInput" id="swatch-0-gray" type="radio"
                            ...
                            <div className="wrapQtyBtn">
                              <div className="qtyField">
                                ...
                                <input type="text" id="Quantity" name="quantity"
                                  value="1" className="product-form__input qty" />
